...
<body>
  ...
  <h2>Sen-Calculatrice</h2>

  <div class="container">
    <form action="index.php" method="post">
      <label for="nbr1">Nombre 1</label>
      <input type="text" id="nbr1" name="nombre1" required placeholder="Entrer un chiffre..">

      <label for="nbr2">Nombre 2</label>
      <input type="text" id="nbr2" name="nombre2" required placeholder="Entrer un chiffre..">

      <label for="operateur">Opérateur</label>
      <select id="operateur" name="operateur" required value="Choisissez un opérateur">
